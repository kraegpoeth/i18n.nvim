...
function global_lua_function()
    print "i18n.nvim.myluamodule.init global_lua_function: hello"
end

local function unexported_local_function()
    print "i18n.nvim.myluamodule.init unexported_local_function: hello"
end
...
local function local_lua_function()
    print "i18n.nvim.myluamodule.init local_lua_function: hello"
end
