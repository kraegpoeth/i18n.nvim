...
echo "i18n.nvim.vim: VimL code executing."

function LuaDoItVimL()
    echo "i18n.nvim.vim LuaDoItVimL(): hello"
endfunction
...
lua <<EOF
    function lua_do_it_lua()
        print("i18n.nvim.vim lua_do_it_lua(): hello")
    end

    print "i18n.nvim.vim: Lua code executing."
EOF
